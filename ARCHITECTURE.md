...
- **`children`** (List<UniversalObject>, optional): An ordered list of child `UniversalObject` instances, enabling the composition of complex hierarchies from this single primitive.
